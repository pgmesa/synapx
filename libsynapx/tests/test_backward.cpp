...
int main() {
    ...
    try {
        ...
        // Create two tensors
        synapx::TensorPtr t1 = std::make_shared<synapx::Tensor>(torch::rand({3, 3}));
        synapx::TensorPtr t2 = std::make_shared<synapx::Tensor>(torch::rand({3, 3}), true);
        ...
        synapx::TensorPtr out = t1->add(t2);
